...
Copy all files included with [***WinFormPlus***](https://github.com/TangramDev/WinFormPlus/archive/refs/tags/v1.0.0.0.zip) into the prepared WinForm Project, reference “cosmos.dll”, adjust manifest and compilation configurations</h3>
